...
namespace ImportDataOPM.AppTest.QueryElement
{
    class QueryElement
    {
        ...
        #region Search Particle
        public static void SerachParticle()
        {
            ...
            foreach(ModelItem modelItem in collPart)
            {
                ...
                {
                    if(Path.GetExtension(dataProperty.Value.ToDisplayString()) == ".dgn")
                    {
                        ...
                        {
                            listPart.Add(fileData);
                        }
                    }
                }
            }
        }
        public static ModelItemCollection SearchCategoryAndProperty(ModelItemCollection coll, string catUserName = "", string catInternalName = "", string propUserName = "", string propInternalName = "", string value = "")
        {
            ComApi.InwOpState10 opState = ComBridge.State;
