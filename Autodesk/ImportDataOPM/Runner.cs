        ...
        public override int ExecuteCommand(string commandId, params string[] parameters)
        {
            switch (commandId)
            {
                case "ID_Import_Data":
                    ...
                    AppUnits.ModelHandler modelHandler = new AppUnits.ModelHandler(0);
                    break;
                ...
                case "ID_Other_Test":
                    ...
                    //AppTest.ModelStructure.TestOne testOne = new AppTest.ModelStructure.TestOne();

                    //AppTest.QueryElement.QueryElement.SerachParticle();
                    break;
            }
